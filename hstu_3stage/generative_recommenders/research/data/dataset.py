...
class MusicDatasetV2(torch.utils.data.Dataset):
    """In reverse chronological order."""
    ...
    def load_item(self, data) -> Dict[str, torch.Tensor]:
        ...
        movie_ratios, ratios_len = eval_int_list(
        ...
        historical_ratings = movie_history_ratings[1:]
        historical_timestamps = movie_timestamps[1:]
        historical_ratios = movie_ratios[1:]
        target_ids = movie_history[0]
        target_ratings = movie_history_ratings[0]
        target_timestamps = movie_timestamps[0]
        target_ratios = movie_ratios[0]
        ...
        historical_ratios = _truncate_or_pad_seq(
            historical_ratios,
            max_seq_len,
            self._chronological,
        )
        ...
        ret = {
            ...
            "historical_ratios": torch.tensor(
                historical_ratios, dtype=torch.int64
            ),
            "history_lengths": history_length,
            "target_ids": target_ids,
            "target_ratings": target_ratings,
